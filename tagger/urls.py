...
urlpatterns = [
    ...
    path("save-to-session/", views.add_sentence_to_session,
         name="add_sentence_to_session"),
    path("clear-session/", views.remove_sentences_from_session,
         name="remove_sentences_from_session"),
    path("download-session-sentences/", views.get_session_sentences_as_csv,
